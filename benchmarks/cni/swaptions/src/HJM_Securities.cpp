...
void print_usage(char *name) {
	fprintf(stderr, "Usage: %s <port> <peers file> OPTION [OPTIONS]...\n", name);
...
//	}
	...
	printf("Number of Simulations: %d, Number of swaptions: %d Port: %d PeersFile: %s\n", NUM_TRIALS, nSwaptions, port, peersFile);
	...
	ddm::init(peersFile, port, conf);
	conf->printPinningMap();
	int nCores = ddm::getKernelNum();
