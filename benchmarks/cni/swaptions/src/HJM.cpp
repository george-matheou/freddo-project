...
int HJM_SimPath_Yield(FTYPE **ppdHJMPath, int iN, int iFactors, FTYPE dYears, FTYPE *pdYield, FTYPE **ppdFactors, long *lRndSeed);
...
int Discount_Factors(FTYPE *pdDiscountFactors, int iN,
FTYPE dYears,
FTYPE *pdRatePath)
{
	int i, j;                                //looping variables
...
int Discount_Factors_opt(FTYPE *pdDiscountFactors, int iN,
FTYPE dYears,
FTYPE *pdRatePath)
{
	int i, j;				//looping variables
...
// ***********************************************************************
// ***********************************************************************
int Discount_Factors_Blocking(FTYPE *pdDiscountFactors, int iN,
FTYPE dYears,
FTYPE *pdRatePath, int BLOCKSIZE)
{
